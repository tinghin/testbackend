const form1Model = require("../models/form1.model");
...
module.exports.getFormDetails = async (params, conn) => {
  ...
  const dataSet = await form1Model.getFormDetails(params, conn);
...
module.exports.updateFormStatus = async (params, conn) => {
  ...
  await form1Model.updateFormStatus(params, conn);
};

module.exports.updateFormDetails = async (params, conn) => {
  await formService.updateFormMaster(params, conn);
  await form1Model.updateFormDetails(params, conn);
};
...
module.exports.insertFormDetails = async (params, conn) => {
  ...
  await form1Model.insertFormDetails(params, conn);
  return details_id;
};
